class InstallationsController < ApplicationController
  ...
  private
    ...
    def installation_params
      params.require(:installation).permit(:equipment_id, :department_id, :block_number, :date_of_intallation, :warranty_period, :preventive_maintenance_date, :installed_by, :contact_address, :installation_cost, :note)
    end
end
