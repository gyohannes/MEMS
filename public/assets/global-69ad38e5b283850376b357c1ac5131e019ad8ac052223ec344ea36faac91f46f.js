$(function () {
    ...
    $('.js-exportable').DataTable({
        ...
        buttons: ['colvis', 'copy', { extend: 'excelHtml5', footer: true }, { extend: 'csvHtml5', footer: true }, 'print'],
    });
    ...
    $("#store_registration_equipment_attributes_inventory_number").autocomplete({
        ...
        select: function( event, ui ) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#inventory_equipment_attributes_organization_unit_id").val(data[0].organization_unit_id)
    ...
    $("#inventory_equipment").autocomplete({
        source: function( request, response ) {
            $.ajax({
                url: "/equipment/facility_equipment_search",
                data: {term: request.term},
        ...
        select: function( event, ui ) {
            $.ajax({
                url: "/inventories/load_facility_equipment",
                data: {term: ui.item.value},
